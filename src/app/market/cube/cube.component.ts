...
export const tempCourse = [
  {
    img: environment.staticContentPath + '/images/courses/cube-course.png',
    title: 'JEE Test',
    author: 'CUBE Tutorials Pvt. Ltd.',
    id: '5ad0992407381a32b7f688dc',
    price: 500,
    couponCode: 'CUBEFR'
  }
];
...
export class CubeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.partnerdata = {
      img: this.staticContentPath + '/images/cube.png',
      title: 'CUBE Tutorials Pvt. Ltd.',
      description: ''
    };
